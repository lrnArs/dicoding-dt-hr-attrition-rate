...
**Dashboard Access**: [Link to Looker Studio Dashboard]  
*Note: Since Looker Studio is cloud-based, the dashboard can be shared via a link. The data source is a cleaned CSV file uploaded to Google Sheets.*
